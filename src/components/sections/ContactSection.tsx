          ...
          <AnimateOnScroll animation="slide-right">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Button variant="goldOutline" size="xl" asChild>
                <a href="tel:017624037187">Jetzt anrufen</a>
              </Button>
            </div>
          </AnimateOnScroll>
          ...
          <AnimateOnScroll animation="slide-left">
            <div className="relative">
              <div className="aspect-square lg:aspect-[4/5] rounded-sm overflow-hidden border border-border">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d38848.94073023514!2d13.341559119531265!3d52.5142750221677!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47a851e9d5a3fc73%3A0x838778129d791c35!2sBarber%20by%20Sencer!5e0!3m2!1sde!2sde!4v1771361868630!5m2!1sde!2sde"
                  width="100%"
                  height="100%"
                  ...
                  title="Standort Gentlemens Barbershop – Berlin"
                />
              </div>
