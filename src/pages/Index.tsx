  ...
  return (
    <>
      <Helmet>
        ...
        <title>Barbershop Berlin | Barber by Sencer</title>
        <meta
          name="description"
          content="Besuche unseren Premium Barbershop Barber by Sencer in Berlin für erstklassige Haarschnitte, Bartpflege und individuelle Styles. Jetzt Termin buchen!"
        />
        <meta
          name="keywords"
        ...
        {/* Open Graph */}
        <meta property="og:title" content="Barber by Sencer | Premium Barbershop Berlin" />
        <meta
        ...
        <meta name="twitter:title" content="Barber by Sencer | Premium Barbershop Berlin" />
        <meta
